<?php 
    ...
    if(isset($_POST['getProduct'])){
		...
		if(isset($_POST['price_sorted'])){
			$product_query="SELECT * FROM tbl_product ORDER BY product_price";
		}
		elseif(isset($_POST['pop_sorted'])){
			$product_query="SELECT * FROM tbl_product ORDER BY RAND()";
		}
		else{
		$product_query="SELECT * FROM tbl_product LIMIT $start,$limit";
		}
	...
	if(isset($_POST['get_selected_Category']) || isset($_POST['get_selected_brand']) || isset($_POST['search']) || isset($_POST['price_sorted']))
	{
		if(isset($_POST['get_selected_Category'])){
			$cid=$_POST['cat_id'];
			$sql="SELECT * FROM tbl_product WHERE product_cat=$cid";
		}
		elseif(isset($_POST['get_selected_brand'])){
			$bid=$_POST['brand_id'];
			$sql="SELECT * FROM tbl_product WHERE product_brand=$bid";
			if(isset($_POST['price_sorted'])){
			$sql="SELECT * FROM tbl_product ORDER BY product_price";
			}
		}
		elseif(isset($_POST['search'])){
			$keyword=$_POST['keyword'];
			$sql="SELECT * FROM tbl_product WHERE product_keywords LIKE '%$keyword%'";
			if(isset($_POST['price_sorted'])){
			$sql="SELECT * FROM tbl_product ORDER BY product_price";
		}
		}
