...
<body>
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3"><strong>Price in Tsh</strong></div>
								</div>
								<hr>
								<div id="cartmenu">
								<!--<div class="row">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Hello, <?php echo $_SESSION['username']; ?></a>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="download.jpeg"></div>
	    <div><img src="images9.jpeg"></div>
	    <div><img src="images5.jpeg"></div>
  	</div>
